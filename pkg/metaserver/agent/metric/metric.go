...
func (m *MalachiteMetricsFetcher) processQoSClassCPUData(qosClass string, cgStats *cgroup.MalachiteCgroupInfo) {
	if cgStats.CgroupType == "V1" {
		...
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricCPUUsageQoSClass, metric.MetricData{Value: float64(cpu.NewCPUBasicInfo.CPUUsage-cpu.OldCPUBasicInfo.CPUUsage) / (float64(cpu.NewCPUBasicInfo.UpdateTime-cpu.OldCPUBasicInfo.UpdateTime) * 1e9), Time: &updateTime})
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricCPUUsageRatioQoSClass, metric.MetricData{Value: cpu.CPUUsageRatio, Time: &updateTime})
		...
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricCPUUsageRatioQoSClass, metric.MetricData{Time: &updateTime, Value: cpu.CPUUsageRatio})
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricCPUUsageUserQoSClass, metric.MetricData{Time: &updateTime, Value: cpu.CPUUserUsageRatio})
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricCPUUsageSysQoSClass, metric.MetricData{Time: &updateTime, Value: cpu.CPUSysUsageRatio})

		m.metricStore.SetQosClassMetric(qosClass, consts.MetricCPUNrRunnableQoSClass, metric.MetricData{Time: &updateTime, Value: float64(cpu.TaskNrRunning)})
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricCPUNrUninterruptibleQoSClass, metric.MetricData{Time: &updateTime, Value: float64(cpu.TaskNrUninterruptible)})
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricCPUNrIOWaitQoSClass, metric.MetricData{Time: &updateTime, Value: float64(cpu.TaskNrIoWait)})

		m.metricStore.SetQosClassMetric(qosClass, consts.MetricLoad1MinQoSClass, metric.MetricData{Time: &updateTime, Value: cpu.Load.One})
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricLoad5MinQoSClass, metric.MetricData{Time: &updateTime, Value: cpu.Load.Five})
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricLoad15MinQoSClass, metric.MetricData{Time: &updateTime, Value: cpu.Load.Fifteen})
	}
}
...
func (m *MalachiteMetricsFetcher) processQoSClassMemoryData(qosClass string, cgStats *cgroup.MalachiteCgroupInfo) {
	if cgStats.CgroupType == "V1" {
		...
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricMemShmemQoSClass, metric.MetricData{Time: &updateTime, Value: float64(mem.MemStats.Shmem)})
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricMemPgfaultQoSClass, metric.MetricData{Time: &updateTime, Value: float64(mem.MemStats.Pgfault)})
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricMemPgmajfaultQoSClass, metric.MetricData{Time: &updateTime, Value: float64(mem.MemStats.Pgmajfault)})

		m.metricStore.SetQosClassMetric(qosClass, consts.MetricMemOomQoSClass, metric.MetricData{Time: &updateTime, Value: float64(mem.OomCnt)})
		m.metricStore.SetQosClassMetric(qosClass, consts.MetricMemScaleFactorQoSClass, metric.MetricData{Time: &updateTime, Value: general.UInt64PointerToFloat64(mem.WatermarkScaleFactor)})
	}
}
